...
(function ($) {
  $(document).ready(function () {
    ...
    /*$('#blog-overview-date-range').datepicker({language: 'ru'});
    $('#blog-overview-date-range-2').datepicker({language: 'ru'});
    $('#blog-overview-date-range-3').datepicker({language: 'ru'});
    $('.blog-overview-date-range-all').datepicker({language: 'ru'});
      $('.blog-overview-date-range-all').on('changeDate', function(ev){
          $(this).datepicker('hide');
      });
      $('#blog-overview-date-range-1').on('changeDate', function(ev){
          $(this).datepicker('hide');
      });
      $('#blog-overview-date-range-2-1').on('changeDate', function(ev){
          $(this).datepicker('hide');
      });
      $('#blog-overview-date-range-3-1').on('changeDate', function(ev){
          $(this).datepicker('hide');
      });*/
